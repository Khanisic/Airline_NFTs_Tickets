...
function Search() {
    ...
    const { details, setDetails, tripDetails, setTripDetails, recover } = useContext(AirlineContext)
    ...
    return (
        <div className='bg-blue w-full md:h-full h-full px-20 py-20'>
